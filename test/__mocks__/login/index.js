...
const getRsakey = () =>
  Promise.resolve(`{"errno":'0',"msg":'',"pubkey":'${pubkey}',"key":'${rsakey}',    "traceid": ""}`)
const logincheck = () =>
  Promise.resolve({
    ubi: [`UBI=${updateUbi}`],
    errInfo: { no: '0' },
    data: { codeString: '', vcodetype: '', userid: '', mobile: '', displayname: '', isconnect: '' },
    traceid: ''
  })
const reggetcodestr = () => Promise.resolve()
const genimage = () => Promise.resolve()
const checkvcode = () => Promise.resolve()
const getRedirectUrl = () => Promise.resolve({ redirectUrl: 'https://pan.baidu.com/disk/home' })
